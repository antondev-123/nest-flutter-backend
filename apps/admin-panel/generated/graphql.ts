...
export type ComplaintsListQueryVariables = Exact<{
  ...
  sorting?: InputMaybe<Array<ComplaintSort> | ComplaintSort>;
}>;
...
export type DriverFeedbacksQuery = { __typename?: 'Query', feedbacks: { __typename?: 'FeedbackConnection', totalCount: number, nodes: Array<{ __typename?: 'Feedback', id: string, requestId: string, reviewTimestamp: any, score: number, description?: string | null, parameters: Array<{ __typename?: 'FeedbackParameter', isGood: boolean, title: string }> }> } };
...
export type ProviderWalletsListQueryVariables = Exact<{
  paging?: InputMaybe<OffsetPaging>;
  sorting?: InputMaybe<Array<ProviderTransactionSort> | ProviderTransactionSort>;
}>;
